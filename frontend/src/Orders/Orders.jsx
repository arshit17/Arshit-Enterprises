    ...
    function Orders() {
        ...
        const fetchOrders = () => {
            ...
            fetch('https://arshit-enterprises.onrender.com/user-orders', {
                method: 'GET',
                headers: {
        ...
        const fetchRefunds = () => {
            ...
            fetch('https://arshit-enterprises.onrender.com/user-refunds', {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${token}`
        ...
        const fetchUserReviews = () => {
            ...
            fetch("https://arshit-enterprises.onrender.com/user-reviews", {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    Authorization: `Bearer ${token}`
        ...
        const handleReview = async (orderId, itemId, rating, reviewText) => {
            ...
            try {
                ...
                const res = await fetch("https://arshit-enterprises.onrender.com/reviews", {
                    method: 'POST',
                    headers: {
                        "Content-Type": "application/json",
        ...
        const getOrderStatus = async (orderId) => {
            try {
                const res = await fetch(`https://arshit-enterprises.onrender.com/order-status/${orderId}`);
                if (res.ok) {
        ...
        const handleCancelOrder = async (itemId, orderData, itemData) => {
            ...
            try {
                ...
                const res = await fetch(`https://arshit-enterprises.onrender.com/cancel-order/${itemId}`, {
                    method: "DELETE",
                    headers: {
                        "Content-Type": "application/json",
                        "Authorization": `Bearer ${token}`
        ...
        const checkRefundStatus = async (refundId) => {
            ...
            try {
                const res = await fetch(`https://arshit-enterprises.onrender.com/refund-status/${refundId}`, {
                    method: 'GET',
                    headers: {
                        'Content-Type': 'application/json',
                        'Authorization': `Bearer ${token}`
